        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,TimeStamp,Text,RowVersion")] NewsItem newsItem)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                catch (DbUpdateConcurrencyException e)
                {
                    ...
                    {
                        ModelState.AddModelError("", "The data has been modified or deleted by other user");
                        var entry = e.Entries.Single();
                        var clientValues = (NewsItem)entry.Entity;
                        var databaseEntry = entry.GetDatabaseValues();
                        var databaseValues = (NewsItem)databaseEntry.ToObject();

                        newsItem.RowVersion = (byte[])databaseValues.RowVersion;
