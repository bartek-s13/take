...
public class LoginBean {
    ...
    public String login() {
        if (getUsername().equals(getPassword())) {
            return "success";
        } else if (getUsername().equals("scott") && getPassword().equals("tiger")) {
            String message = ResourceBundle.getBundle("ApplicationMessages")
                    .getString("validation.oracle");
            FacesMessage facesMessage = new FacesMessage(SEVERITY_ERROR, message, "oracle error");
